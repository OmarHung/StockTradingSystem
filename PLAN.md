...
| WebUI | React 19 + Vite + lightweight-charts / FastAPI 後端（介面與技術棧參考 [shioaji-pro-app](https://github.com/Sinotrade/shioaji-pro-app)） | 專業交易終端；所有 CLI 操作皆可在 WebUI 執行，長任務走 jobs 背景機制 |
...
| RAG 新聞相關性過濾 | Phase 2 | 新聞分析師已實作（標題直餵）；embedding 相關性評分過濾未做 |
